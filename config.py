...
N_onboarding_data = "1CbYaJasLJ9SRtg0QxfCeP6nYrcsD5gJkMZo8c1aLebY"
...
languages = [
    {"language": "tam", "code": "si"},
    {"language": "sin", "code": "ta"}
]
...
def create_config():
    return {
        ...
        "sg_sources": [
            {
               "key": "tam",
               "path": "excel_files/safeguarding tam.xlsx",
            },
            {
               "key": "sin",
               "path": "excel_files/safeguarding sin.xlsx",
            }
        ],
        "sources": sources,
